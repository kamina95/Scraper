...
public class GraphicCardNose {
    ...
    public GraphicCardNose(int id, String model, String brand, String memorySize, String displays, String resoulution, String color, String memoryInterface) {
        this.id = id;
        this.model = model;
        this.brand = brand;
